...
const RegisterForm = () => {
  ...
  const onSubmit = () => {
    ...
    setTimeout(() => {
      toast.error("Sign-up isn't wired up yet — this is a UI preview.");
              ...
              <FormItem>
                <FormControl>
                  <div className="relative">
                    <UserRound className="absolute start-5 top-1/2 -translate-y-1/2 text-xl text-neutral-700 dark:text-neutral-200 w-5 h-5" />
                    <Input
                      {...field}
                      type="text"
